...
sleep(1)
place_all_boats(board_user, available_boats, boat_position_list_user)
sleep(1)
...
sleep(1)
place_all_boats_random(board_machine, available_boats_random, boat_position_list_machine)
...
while True:
    print("Your turn  \n")
    sleep(1)
    print(pd.DataFrame(board_shooting_user), "\n")
    sleep(1)
